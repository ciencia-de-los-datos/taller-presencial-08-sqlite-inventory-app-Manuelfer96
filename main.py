...
handler = logging.FileHandler('opdb-app.log')  # Log to a file
...
def get_db():
    ...
    if "db" not in g:
        ...
        try:
            app.logger.info("Database Connection")
...
def requestparts():
    ...
    if part_no and req_amt:
        ...
        app.logger.info("REQUESTPARTS().results = %s", result)
